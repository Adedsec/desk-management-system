<div class="mt-4">
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="w-25">
            <input class="form-control" placeholder="فیلتر پروژه ها ..." name="filter" wire:model="filter" type="text">
        </div>
    </div>
        ...
        <div class="col-md-2 p-2">
            <a class="text-decoration-none text-dark" href="{{route('projects.create')}}">
                <div class="card  h-100 shadow-sm " style="border-style: dashed">
                    <div class="card-body h-100 rounded-3 d-flex flex-column justify-content-center align-items-center">
